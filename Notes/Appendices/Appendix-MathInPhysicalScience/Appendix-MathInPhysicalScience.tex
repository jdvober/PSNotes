...
\\
V_2 &= \frac{(\qty{10}{\Ccancel[orange]{atm}}) \cdot (\qty{2}{mL})}{(\qty{28}{\Ccancel[orange]{atm}})}\marginnote{You can treat the units and numbers almost as two seperate things.  See \ref{sec:AppendixUnits} for more details.}
\\
V_2 &= \frac{(\qty{20}{mL})}{(\qty{28})}\\
\end{align*}

\subsubsection{Answer with units}
\begin{align*}
\Aboxed{V_2 &= \qty{0.71}{mL}}
\end{align*}
