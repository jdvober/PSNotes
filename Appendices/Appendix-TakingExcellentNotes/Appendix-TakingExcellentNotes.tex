...
\begin{enumerate}
	\item Excellent notes use an \underline{Outline} format
	      \begin{itemize}
		      \item \dracRed{This is required for my class to get your points for notes!}
	...
	\item Advanced / Extra stuff
	      \begin{itemize}
		      \item \dracPurple{To really take your notes to the next level, incorporate colors.}
		      \item \colorbox{dracCyan}{\dracRed{Bring different colored pens and highlighters to draw attention to specific details.}}
		            \margincloud{Questions/Thoughts}
		      \item \dracOrange{Come up with your own system of what each color means.}
	      \end{itemize}
