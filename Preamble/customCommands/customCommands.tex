...
\newcommand{\highlight}[2][]{
	...
	\pgfkeys{
		/highlight/color/.initial=dracPink,
	}
	\edef\highlightcolor{\pgfkeysvalueof{/highlight/color}}%

	\colorbox{\highlightcolor}{#2}
}
...
\input{../Preamble/customCommands/gradientArrows.tex}
